...
const watcherPath = "frontend/src/NotificationWatcher.jsx";
const cssPath = "frontend/src/styles.css";
const watcherCssPath = "frontend/src/notificationWatcher.css";
...
app = replaceOnce(app, `<main className="appShell">`, `<main className={\`appShell ${isDarkMode ? "darkMode" : ""}\`}>`, "dark mode class");
app = replaceOnce(
  app,
...
let watcherCss = fs.readFileSync(watcherCssPath, "utf8");
...
`;
fs.writeFileSync(watcherCssPath, watcherCss);
